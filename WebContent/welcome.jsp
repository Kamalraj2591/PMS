<%@page import="com.xortican.pms.dao.LoginDao"%>
<%@page import="com.xortican.pms.controller.LoginController"%>
    ...
    <div class="container">
      ...
      <div class="container">
        <div class="row" id="homebody">
          <div class="col-md-9">
            <p class="bth">PAYROLL MANAGEMENT SYSTEM : : Welcome : <%= session.getAttribute("empId") %></p>
